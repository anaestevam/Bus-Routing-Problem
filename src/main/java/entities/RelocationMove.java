...
public class RelocationMove {
    ...
    protected static boolean capConstrainsAreViolated(Route targetRoute, int incomingDemand) {
        return targetRoute.getBus().getRemainingCap() < incomingDemand;
    }
    ...
    protected void applyRelocationMove() {
        ...
        fromRoute.getBus().setRemainingCap(fromRemainingCap);
        toRoute.getBus().setRemainingCap(toRemainingCap);
